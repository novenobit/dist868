<?php
//include("$dirRoot"."data/showCat2.php");
?>
<style>
.swiper-button-prev,
.swiper-button-next {
...
<?php
     ...
     $numFilas=0;
     $sqlSubCat2=mysqli_query($conex1,"select id_subcategoria,cod_subcategoria,nom_subcategoria,foto_subcategoria from subcategoria where cod_categoria='$codCat'");
