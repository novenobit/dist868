...
<div class="ui container">
 <div class="ui stackable centered grid autoplay">
  <?php
     ...
     $valor=200;
     $sqlProDataAdd=mysqli_query($conex1,"select id_producto,cod_producto,nom_producto,precio1_producto,foto_producto from productos where foto_producto<>'' and activo='S' order by rand() limit 15");
       ...
       <div class="card aos-item" aos="flip-left" data-aos-delay='<?php echo $valor; ?>'>
        <div class="image">
         <?php
           echo "<a href='vercat3.php?idpro=$idpro'>";
            ...
            {
             echo "<img class='ui small image' src='$dirRoot"."imagenes/sinfoto.png' style='height:200px;' alt='$nomProducto'>";
            }
            else
            {
              echo "<img class='ui small image' src='$dirRoot"."imagenes/productos/$fotoProducto' style='height:200px;' alt='$nomProducto'>";
            }
           echo "</a>";
         ?>
        </div>
        <div class="content">
         <span class="ui small red text">
          <a span class='font-10'><?php echo $nomProducto; ?></a>
         </span>
        </div>
       </div>
      </div>
