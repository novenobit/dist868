  ...
  <div class="column">
       <div class="ui breadcrumb">
        <?php
         ...
         <i class='right angle icon divider'></i>
         <a class='section' data-inverted='' data-tooltip='Ver los Presupuestos de {$usuarioData['nombre']}' data-position='top left' href='usuarios-ver-ventas.php?op=ven&id=$iduser&iduser=$iduser'>Ventas</a>
         <i class='right angle icon divider'></i>
         <a class='section' data-inverted='' data-tooltip='Grafico de Presupuestos' data-position='top left' href='usuarios-graph.php?op=gra&id=$iduser&iduser=$iduser'>Graphs</a>
         <i class='right angle icon divider'></i>
