...
if(!isset($op))
{  $op=""; }
echo "<a class='ui green button' href='usuario-edit1.php?op=edt&id=$iduser&iduser=$iduser' target='data2'>Edita</a>
<a class='ui green button' href='usuario-del1.php?op=del&id=$iduser&iduser=$iduser' target='data2'>Borrar</a>
<a class='ui green button' href='usuarios-ver-ventas.php?op=ven&id=$iduser&iduser=$iduser'>Ventas</a>";
?>
