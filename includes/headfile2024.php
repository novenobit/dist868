...
if($mobile=="S")
{
 ...
 {
?>
<body id="top" translate="no" style="background-color:#f1f5f7;color:#000;margin-top:60px;">
<?php
 }
 if($mobile=="S" and $topAdmin=="S" )
 {
?>
<body id="top" translate="no" style="background-color:#f1f5f7;margin-top:60px;">
<?php
 }
}
...
if($mobile=="N")
{
 if($topAdmin=="N")
 {
  ...
  {
?>
<body id="top" translate="no" style="margin-top:70px;" onLoad="document.forms[0].elements[0].focus()">
<?php
  }
  else
  {
?>
<body id="top" translate="no" style="margin-top:70px;">
<?php
  }
 }
 if($topAdmin=="S" and $forms=="N")
 {
?>
<body id="top" translate="no">
<?php
 }
 if($forms=="S" and $topAdmin=="S")
 {
?>
<body id="top" translate="no" style="margin-top:70px;" onLoad="document.forms[0].elements[0].focus()">
<?php
