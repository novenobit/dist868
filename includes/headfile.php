...
if($mobile=="S")
{
 ...
 {
?>
<body id="top" translate="no" style="background-color:#e3e6e6;color:#000;margin-top:53px;">
<?php
 }
 if($mobile=="S" and $topAdmin=="S" )
 {
?>
<body id="top" translate="no" style="background-color:#e3e6e6;margin-top:50px;">
<?php
 }
}
