...
<tbody>
<?php
$sqldata="select id_producto,codigo_barra,nom_producto,precio1_producto,precio2_producto,precio3_producto,precio4_producto from productos where cod_subcategoria=''";
...
while($proData=mysqli_fetch_array($sql))
{
 ...
 echo "<tr>";
      ...
      <td>". number_format($precio4_producto,2,',', '.') . "</td>
   </tr>";
   $num++;
}
?>
