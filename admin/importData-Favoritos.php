...
<div class="ui grid">
  <div class="ten wide column">
    <h2>Importar Productos Favoritos</h2>
...
// ----------------------------
$fileD868="productos-favoritos.csv";
...
//-----------------------------------------------
   ...
   {
    $numFilas1=0;
    $sqlData=mysqli_query($conex1, "select id_producto,nom_producto from productos where codigo_barra='$codigo_barra'");
    ...
    if($numFilas1>0)
    {
      ...
      //--------------------------
      $query2="update productos set especial='S' where id_producto='$id'";
