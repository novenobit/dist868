...
<h2>Productos Repetidos Por Codigo de Producto</h2>
...
while($proData=mysqli_fetch_array($sql))
{
 ...
 $numFilas1=0;
 $sql2=mysqli_query($conex1, "select id_producto,cod_producto,codigo_barra,nom_producto,precio1_producto,precio2_producto,precio3_producto from productos where cod_producto='$cod_producto' and id_producto<>'$id_producto'");
...
// Data 2----------------------------------
   ...
   if($codigo_barra<>$D2codigo_barra)
   {
     $queryA1="update productos set cod_producto='$codigo_barra' where id_producto='$id_producto'";
     $resultA1=mysqli_query($conex1,$queryA1);
     $queryA2="update productos set cod_producto='$D2codigo_barra' where id_producto='$D2id_producto2'";
     $resultA2=mysqli_query($conex1,$queryA2);
     $numUpdate++;
   }
   if($op=="del")
   {
...
<div class="ui grid">
 <div class="eight wide column">
   <?php
    ...
    if($num>0 and $numUpdate==0)
    {
     echo "<a class='ui red button' href='CheckProRepetidoCod.php?op=del'>Borrar Datos</a>";
    }
   ?>
  </div>
  <div class="eight wide column">
