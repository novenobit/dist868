...
// ----------------------------------------
 ...
 if($Tnom_producto<>"")
 {
  ...
  $sql2=mysqli_query($conex1, "select * from productos where cod_producto='$Tcod_producto' or codigo_barra='$Tcodigo_barra'");
  $numFilas1=mysqli_num_rows($sql2);
  $numFilas3=0;
  $sql3=mysqli_query($conex1, "select id_producto from productos where nom_producto='$TempNom_producto'");
