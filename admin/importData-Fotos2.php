...
if($fileOpenD868 !== FALSE)
{
 ...
 // Agregar Datos  -------------------------------------------
  ...
  {
    $sql1=mysqli_query($conex1, "select nom_producto,foto_producto from productos where codigo_barra='$codigo_barra'");
    $numFilas=0;
...
echo "<br>Cambios: $num /RandNum: ".rand();
fclose($fileOpenD868);
if($num>0)
{ exit(); }
?>
