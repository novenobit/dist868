...
<div class="ui grid">
 <div class="ten wide column"><h1>Delete Imagen</h1></div>
       ...
       echo "<tr>
        ...
        <td style='background-color:#ffffff;color:#000000;padding: 10px;'>
          <h3>Nombre: $filename</h3>";
           echo "<form class='ui large form' action='image-del2.php?nom=$filename' method='POST' enctype='multipart/form-data' id='submitForm'>";
?>
             <div class="ui stacked segment">
               <input type="hidden" id="nom" name="nom" value="<?php echo $nom; ?>">
               <button class="ui fluid large red submit button" type="submit">Borrar Imagen</button>
             </div>
          </form>
<?php
          echo "</td>
...
$(document).ready(function (e) {
 $("#submitForm").on('submit',(function(e) {
  e.preventDefault();
  $.ajax({
      url: "image-del2.php?nom=<?php echo '$nom&returnTo=$returnTo'; ?>",
   type: "POST",
