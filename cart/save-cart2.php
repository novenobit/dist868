...
if(isset($_SESSION['check']) and isset($_POST['captcha']))
{
 ...
 {  $captcha="No";
   ...
   echo "<html><meta http-equiv=refresh content=3;url=save-cart1.php>";
   exit();
 }
}
...
if($captcha=="yes")
{
 ...
 { echo "<html><meta http-equiv=refresh content=0;url=save-cart1.php>";
   exit();
 }
//--------------------
...
// echo "<br>select id_cliente,email_cliente,clave,idnivel from email_clientes where email_cliente='$email_cliente' and clave='$clave' and activo='S'";
 $sqlUser=mysqli_query($conex1,"select id_cliente,email_cliente,clave,nom_cliente from clientes where email_cliente='$email_cliente' and cod_cliente='$clave' and activo='S'");
...
$query1="insert into cart1(numsession, email_cliente, hora, submitted, rand_num)
...
$result1=mysqli_query($conex1,$query1);
         ...
         <table class="ui celled table">
            ...
            // $conex2 = new mysqli('localhost', 'root', 'admin2111', 'dist868');
                  ...
                  $sql = "SELECT id_producto,nom_producto,precio1_producto FROM productos WHERE id_producto IN (".implode(',',$_SESSION['cart']).")";
...
$query2="insert into cart2(numsession,id_producto, cantidad, precio, email_cliente, hora, submitted, rand_num)
