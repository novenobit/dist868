...
<div class="ui main text container">
    ...
    <div class="ui hidden divider"></div>
      <form class="ui form" method="POST" action="save-cart1.php">
                        ...
                        <tr>
                           <td style="width:100px;">
                              <?php
                               ...
                               { $foto="sinimage.png"; }
                               echo "<img class='ui image' src='../imagenes/productos/".$row['foto_producto']."' style=''>";
                              ?>
                           </td>
         ...
         <a href="../index.php" class="ui blue button"><i class="angle double left icon"></i> Regresar</a>
             <button class="ui blue button" type="submit"><i class="cart arrow down icon"></i> Guardar</button>
         <a href="clear-cart.php" class="ui blue button"><i class="eraser icon"></i> Limpia Cesta</a>
         <a href="checkout.php" class="ui blue button"><i class="credit card icon"></i> Pagar</a>
      </form>
</div>
