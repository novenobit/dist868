...
// ------------------------------------------------------------------
 ...
 echo "<tr>
  ...
  if($areasSistema['EditaClientes']=="S")
  {
   echo "<td><a href='../clientes/cliente-del1.php?op=cl&id_cliente={$clienteData['id_cliente']}' >
   <img src='$dirRoot"."imagenes/graphs/borrar.png' alt='Borrar {$clienteData['nom_cliente']}'></a></td>
   <td><a href='../clientes/cliente-edit1.php?op=cl&id_cliente={$clienteData['id_cliente']}'>
  ...
  {
   echo "<td>
   <img src='$dirRoot"."imagenes/graphs/borrar.png' alt='Borrar {$clienteData['nom_cliente']}'></td>
   <td>
   <img src='$dirRoot"."imagenes/graphs/edita.png'  alt='Edita {$clienteData['nom_cliente']}'></td>
   <td>
   <img src='$dirRoot"."imagenes/graphs/verdatos.gif'  alt='Ver {$clienteData['nom_cliente']}'></td>";
  }
  echo "</tr>";
  $ves++;
  if($ves==3)
