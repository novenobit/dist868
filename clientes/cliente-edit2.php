...
else
{
 ...
 // exit();
  ...
  if($numventas==0)
  {
    if($clienteData['cid_cliente']<>$Mcid_cliente and $Mcid_cliente<>"")
    {
     $queryCLI="UPDATE clientes set cid_cliente='$Mcid_cliente' where clientes.id_cliente='{$clienteData['id_cliente']}'";
