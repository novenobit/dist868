 ...
 <div id="content">
   ...
   <div class="ui grid">
    <div class="sixteen wide column">
      <h2 class="menu-label">Cliente Nuevo</h2>
    </div>
    <div class="twelve wide column">

        <form class="ui form" action="'cliente-nuevo2.php?op=cl" method="POST" enctype="multipart/form-data" id="submitForm">
         <div class="ui stackable grid" style="background-color:#1549e6;color:#ffffff;">
         ...
         <div class='eight wide column'>
         <?php
           echo "<label>Direcci&oacute;n2</label>
         ...
         <?php
           echo "<label>Clave de Acceso <i class='check icon'></i></label>
