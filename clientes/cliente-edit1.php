...
echo "<form class='ui form' action='../clientes/cliente-edit2.php?op=cl&id_cliente=$id_cliente' method='post' style='color:#000000;'>";
?>
 ...
 <div class="ui text container">
    ...
    <div class="fields">
     ...
     <div class='field'>
       <input class="ui button pink" type="submit" value='Enviar Datos'>
