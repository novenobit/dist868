...
?>
 <table class='ui  table'>
    ...
    while($pagoData=mysqli_fetch_array($sqlPagos))
    {
        ...
        echo "<tr>
          ...
          <td class='center aligned '>
            <a href='erase-pagos.php?id=$idPago&id_cuenta=$id_cuenta&sistema=$sistema'><i class='erase icon' style='visibility: visible;'></i></a>
          </td>
        </tr>";
    }
    ?>
 ...
 if($Tmontopago>=$monto_apagar)
 {
   echo "<div class='ui raised segment'>
     Ya Puede Cerrar la Cuenta <a class='ui primary button' href='cerrar-cesta5.php?id_cuenta=$id_cuenta&sistema=$sistema'>Cierra la Cuenta</a>
   </div>";
 }
}
//if($Tmontopago==
