...
<table style="width:600px;">
 <thead>
  <tr>
   ...
   <th class='grey center aligned'>UxBulto</th>
   ...
   <th class='grey center aligned'>Total</th>
  </tr>
 </thead>
 <tbody>
<?php
...
// Check Price
    ...
    echo "<tr>
     ...
     <td class='right aligned'>". number_format($total, 2, '.', '')."</td>
    </tr>";
    $num++;
    $reg++;
  }
...
<?php
if(isset($Ttotal) and $Ttotal>0)
{
?>
<table style="width:600px;">
 <tbody>
   <tfoot><tr>
     <td class='right aligned'><b>Total: <?php echo number_format($Ttotal, 2, '.', ''); ?></b></td>
    </tr></tfoot>
 </tbody>
</table>
<?php
