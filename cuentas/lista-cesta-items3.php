 ...
 <?php
  ...
  if($numFilas>0)
  {
    while($cestaData=mysqli_fetch_array($sqlCesta))
    {
      ...
      $sqlPro=mysqli_query($conex1,"select id_producto,cod_producto,cod_producto,codigo_barra,cod_categoria,cod_subcategoria, nom_producto,precio1_producto,precio2_producto,precio3_producto,precio4_producto from productos where id_producto='$id_producto'");
