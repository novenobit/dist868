...
<?php
 ...
 $sqlCuentas=mysqli_query($conex1,"select usuario,id_cuenta, cid_cliente, descuento, monto_apagar,preparado,chequeado,despachado,fecha,sistema from cuentas1 where cid_cliente='$usuario' order by id_cuenta desc limit 10");
