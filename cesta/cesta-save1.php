 ...
 <div class="ui bottom attached active tab segment" data-tab="Form">
  ...
  <div class="ui middle aligned center aligned grid">
   <div class="column">
    ...
    <form class="ui large form" action="cesta-save2.php" method='post' enctype="multipart/form-data">
                  ...
                  $query = $conex2->query($sql);
                     while($row = $query->fetch_assoc()){
                        ...
                        <tr>
                           ...
                           <td class='center aligned'>
                             <?php echo "<a href='cesta-delete-item.php?id={$row['id_producto']}&index=$index'><i class='eraser icon red'></i></a>"; ?>
                           </td>
                        </tr>
                        <?php
                        $index ++;
