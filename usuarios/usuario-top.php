...
// }
?>
 <div class="ui stackable inverted padded grid">
  <div class="sixteen wide column">
    ...
    <div class="ui breadcrumb">
        <?php
         if(!isset($op))
         {  $op=""; }
         //echo "<a class='section' data-inverted='' data-tooltip='Ver los Datos de {$usuarioData['nombre']}' data-position='top left' href='usuario-data.php?op=ver&id=$iduser&iduser=$iduser'>Ver</a>
         //<i class='right angle icon divider'></i>
         //<a class='section' data-inverted='' data-tooltip='Cambia los Datos de {$usuarioData['nombre']}' data-position='top left' href='usuario-edit.php?op=edt&id=$iduser&iduser=$iduser'>Edita</a>
         //<i class='right angle icon divider'></i>
         //<a class='section' data-inverted='' data-tooltip='Borra este usuario de la Tabla' data-position='top left' href='usuario-del1.php?op=del&id=$iduser&iduser=$iduser'>Borrar</a>
         //<i class='right angle icon divider'></i>
         ...
         //<i class='right angle icon divider'></i>
         //<a href='#' onclick='loadPage(\"$dirRoot"."usuarios/usuario-ver.php?op=cl&iduser=$iduser\");return false;'>Reload</a>";
        ?>
    </div>
  </div>
 </div>
