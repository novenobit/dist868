...
<form class='ui form' action='usuarios-nuevo2.php?op=cl' method='post' enctype='multipart/form-data'>
 <div class='ui grid'>
  <div class='eight wide column'>
   <?php
     echo "<label class='w3-label font-pink font-bold'>CI/RIF:</label>
     <input size='15' maxlength='15' type='text' class='ui input' name='cid_usuario'>";
   ?>
  </div>
  <div class='eight wide column'>
   <?php
     echo "<label class='w3-label font-pink font-bold'>Nombre</label>
  ...
  <div class='eight wide column'>
   <?php
     echo "<label class='w3-label font-pink font-bold'>Tel&eacute;fono Celular</label>
