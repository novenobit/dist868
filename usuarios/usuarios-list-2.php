...
<div class='w3-row'>
 <div class='w3-col w3-padding'>
   <a href='../usuarios/usuarios-list-ci.php?op=cl'>Ordenar por CI</a> | <a href='../usuarios/usuarios-list-nom.php?op=cl'>Ordenar por Nombre</a>
   <a href='../usuarios/usuario-nuevo1.php?op=cl'>Agrega Nuevo Usuario</a>
 </div>
</div>
...
<table class='w3-table w3-bordered w3-border' style='width:100%'>
 <tr>
  <td class='w3-border w3-center tableHead'><a href='../usuarios/usuarios-list-ci.php?op=cl'>CI/RIF</a></td>
  <td class='w3-border w3-center tableHead'><a href='../usuarios/usuarios-list-nom.php?op=cl'>Usuario</a></td>
  <td class='w3-border w3-center tableHead'>Tel&eacute;fono</td>
  <td class='w3-border w3-center tableHead'>eMail</td>
  <td class='w3-border w3-center tableHead'>B</td>
  <td class='w3-border w3-center tableHead'>E</td>
  <td class='w3-border w3-center tableHead'>Ver</td>
 </tr>
 <?php
 if(isset($nombre))
 { $nombreORG=$nombre; }
 ...
 while($usuarioData=mysqli_fetch_array($sql))
 {
   ...
   { $bgcolor="#EDEDED"; }
   echo "<tr>
   <td class='w3-border tableData'>{$usuarioData['cid_usuario']}</td>
   <td class='w3-border tableData'>
    <a href='../usuarios/usuarios-ver1.php?op=cl&iduser={$usuarioData['iduser']}' >
     {$usuarioData['nombre']}
    </a>
   </td>
   <td class='w3-border tableData w3-center'>
    {$usuarioData['email']}
   </td>
   <td class='w3-border tableData w3-center'>
    {$usuarioData['email']}
   </td>
   <td class='w3-border tableData w3-center'><a href='../usuarios/usuario-del1.php?op=cl&iduser={$usuarioData['iduser']}' >
   <img src='$dirRoot"."siadre-imagenes/graphs/borrar.png' alt='Borrar {$usuarioData['nombre']}'></a></td>
   <td class='w3-border tableData w3-center'><a href='../usuarios/usuario-edit.php?op=cl&iduser={$usuarioData['iduser']}'>
   <img src='$dirRoot"."siadre-imagenes/graphs/edita.png'  alt='Edita {$usuarioData['nombre']}'></a></td>
   <td class='w3-border tableData w3-center'><a href='../usuarios/usuarios-ver1.php?op=cl&iduser={$usuarioData['iduser']}' >
   <img src='$dirRoot"."siadre-imagenes/graphs/verdatos.png'  alt='Ver {$usuarioData['nombre']}'></a></td>
   </tr>";
   $ves++;
   if($ves==3)
   { $ves=1; }
 ...
 <div class='w3-col w3-padding'>
  <?php
   ...
   if($total_pages<>'1')
   {
    if($page > 1)
     {$prev=($page - 1);
    echo "<a href='../usuarios/usuarios-list1.php?op=cl&page=$prev'>&#171;&#171; Ant</a> "; }
    for($i=1; $i <= $total_pages; $i++)
    {
     if(($page) == $i)
     {
      ...
      echo "<a href='../usuarios/usuarios-list1.php?op=cl&page=$i'>$i</a> ";
     }
    }
    // Build Next Link
    if($page < $total_pages)
    {
     $next=($page + 1);
     echo "<a href='../usuarios/usuarios-list1.php?op=cl&page=$next'>Sig &#187;&#187;</a> ";
    }
   }
...
<a class='w3-button w3-round w3-blue' href='../usuarios/usuario-nuevo1.php?op=cl'>Agrega Nuevo Usuario</a>
<br>
<?php
if(isset($sql))
