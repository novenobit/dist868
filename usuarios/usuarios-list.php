...
<table class="ui unstackable selectable celled long scrolling inverted table">
 <thead>
  <tr>
   <th class='blue'>Nombre Usuario</th>
   <th class='blue center aligned'>User</th>
   <th class='blue center aligned'>CI/RIF</th>
   <th class='blue center aligned'>Telf</th>
   <th class='blue center aligned' style='width:140px;'>Cta</th>
...
if($op=="nom")
{
 ...
 if(!isset($nombre))
 { $nombre="A"; }
 $sql=mysqli_query($conex1,"select * from usuarios where nombre like '$nombre%' and iduser<>'2' and activo<>'N' order by nombre  LIMIT $from, $max_results_siadre");
}
