...
<div class="ui container">
   ...
   <h1>**Consentimiento de cookies**</h1>
   <h3>Política y configuración de cookies</h3>
   <p>Este sitio web solo utiliza cookies cuando crea un Presupuesto.</p>
   ...
   <p><b>Este sitio web solo utiliza cookies cuando agrega articulos a tu Presupuesto.</b></p>
   <p>Puede administrar sus preferencias de cookies haciendo clic en el botón "Configuración de cookies" a continuación.</p>
   <p>Las cookies nos permiten mejorar tu experiencia en (nuestro sitio web). Puedes aceptarlas todas, configurarlas o conocer más de nuestro <a class='ui button' href="politica-privacidad.php">Política de Privacidad</a>.</p>
