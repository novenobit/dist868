...
//--------------------------------
     ...
     {
?>
      <iframe src="goto-page.php?fileToRun=proMasVendido" height='700' width='100%' name='data2'  frameborder='0' scrolling='auto' allowtransparency='true' onload='resizeIframe(this)'></iframe>
      <div class="mainContent">
       <div id="content"></div>
      </div>
<?php
