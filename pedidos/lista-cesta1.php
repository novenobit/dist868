...
// idcesta, id_cuenta, id_producto, cantidad, nota_extra, anulado, usuario, hora, submitted, rand_num
// '$idcesta', '$id_cuenta', '$id_producto', '$cantidad', '$nota_extra', '$anulado', '$usuario', '$hora', '$submitted', '$rand_num'
?>
...
<?php
 ...
 $Ttotal=0;
 $numFilas=0;
 $sqlCesta=mysqli_query($conex1,"select idcesta, id_cuenta, id_producto, cantidad, nota_extra from cuentas2 where id_cuenta='$idcart'");
 ...
 else
 {
   ...
   {
    echo "<tr>
     <td class='center aligned blue'></td>
     <td class='blue'><b>Total</b></td>
     <td class='center aligned blue'></td>
     <td class='center aligned blue'></td>
     <td class='center aligned blue'><b>$Ttotal</b></td>
    </tr>";
   }
 }
